...
std::vector<float> ImageHelpers::loadImage(const std::string& filename, int sizeX, int sizeY) {
...
std::vector<std::string> ImageHelpers::loadLabels(const std::string& filename) {
